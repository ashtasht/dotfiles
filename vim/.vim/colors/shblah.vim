    ...
    highlight clear
        if exists("g:syntax_on")
                syntax reset
                    ...
                    highlight Comment      term=NONE cterm=NONE ctermfg=4    ctermbg=NONE "?
                    highlight Constant     term=NONE cterm=NONE ctermfg=2    ctermbg=NONE
                    ...
                    highlight DiffAdd      term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
                    ...
                    highlight Folded       term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
                    highlight Function     term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
                    highlight Identifier   term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
                    highlight IncSearch    term=NONE cterm=NONE ctermfg=5    ctermbg=5
                    highlight NonText      term=NONE cterm=NONE ctermfg=3    ctermbg=NONE "
                    ...
                    highlight Special      term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
                    highlight SpecialKey   term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
                    highlight Statement    term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
                    highlight StatusLine   term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
                    ...
                    highlight Todo         term=NONE cterm=NONE ctermfg=0    ctermbg=4
                    highlight Type         term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
                    highlight VertSplit    term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
